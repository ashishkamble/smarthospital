...
//**********************************************************************************************
	if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
		if(isset($_POST['login']) && !empty($_SESSION[ 'card' ]) && !empty($Cid)) 
		{
			...
			{  
				$sqll = "UPDATE users SET username='$Uname',SerialNumber='$Number' ,gender='$gender',reason = '$reason' WHERE CardID='$CardID'";
	...
	<table>
      ...
      <input type="radio" name="gender" value="Male" required /><label>Male</label ></td>
		...
		<tr>
			...
			<td><input type="text" placeholder="medical reason" name="reason" required /></td>
		</tr>
		<tr>
    	    <td><input type="submit" value="Register" name="login" id="lo"></td>
